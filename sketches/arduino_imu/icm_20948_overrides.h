...
#ifndef ARDUINO_IMU__ICM_20948_OVERRIDES_H_
#define ARDUINO_IMU__ICM_20948_OVERRIDES_H_

// clang-format off

/*
 * This code was copied and modified from https://github.com/sparkfun/SparkFun_ICM-20948_ArduinoLibrary
 * It was published under License "Creative Commons Share-alike 4.0 International.".
 * For more, follow above link
 */

//#define MODIFY_I2C_MASTER_ODR  // this somehow screws up the magnetic field readings
#define MODIFY_SAMPLE_RATE

// This function is defined as __attribute__((weak)). We make use of this to override it to increase sampling rate.
...
#ifdef MODIFY_I2C_MASTER_ODR
  uint8_t mstODRconfig = 0x02; // Set the ODR configuration to 1100/2^4 = 275Hz
#else
...
#ifdef MODIFY_SAMPLE_RATE
  mySmplrt.g = 4; // leads to observed rate of 227.5 hz
  mySmplrt.a = 4; // leads to observed rate of 227.5 hz
#else
...
#endif // ARDUINO_IMU__ICM_20948_OVERRIDES_H_
